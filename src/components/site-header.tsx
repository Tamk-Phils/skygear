    ...
    <header className="w-full">
      ...
      <div className="bg-navy text-navy-foreground">
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 md:gap-4 md:py-4">
          ...
          >
            ...
            />
            <button type="submit" className="grid size-11 shrink-0 place-items-center bg-primary text-primary-foreground">
        ...
        <div className="border-t border-white/10 px-4 pb-3 md:hidden">
          ...
          >
            ...
            />
            <button type="submit" className="grid size-10 shrink-0 place-items-center bg-primary text-primary-foreground">
      ...
      {open && (
        <div className="border-b border-border bg-card md:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col px-4 py-2 text-sm font-semibold uppercase tracking-wide">
            {NAV.map(n => (
