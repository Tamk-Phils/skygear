...
//#region node_modules/.nitro/vite/services/ssr/assets/email-CcQzF2Tk.js
...
var getTransporter = () => {
	if (!process.env.SPACEMAIL_EMAIL || !process.env.SPACEMAIL_PASSWORD) throw new Error("Missing Spacemail credentials in environment variables");
...
var sendContactEmail = async ({ name, email, subject, message }) => {
...
var sendCheckoutEmail = async ({ orderId, customerEmail, customerName, total }) => {
	const transporter = getTransporter();
	await transporter.sendMail({
...
//#endregion
export { sendCheckoutEmail as n, sendContactEmail as r, createServerRpc as t };
