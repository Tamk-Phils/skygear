...
import { C as resolveManifestCssLink, E as isResolvedRedirect, M as invariant, O as rootRouteId, S as resolveManifestAssetLink, T as isRedirect, a as replaceSsrResponse, b as getScriptPreloadAttrs, i as normalizeSsrResponse, k as isNotFound, l as RouterProvider, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, w as executeRewriteInput, x as getStylesheetHref } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver--zkbWoK3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DAfZOqvX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DHI3Wtkp.mjs"),
		import("./start-_p_sPp3Q.mjs"),
